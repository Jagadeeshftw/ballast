...
| 5 | 1:32–1:54 | **It has already done this.** Both position cards, then the totals row. | "Two positions, both real, both settled on chain. One paid two hundred tUSDC, one paid nothing — and the one that paid nothing is a success, because the price went up. Net across both: minus twenty-four dollars. That's the cost of cover that wasn't needed, and we show it rather than the winner alone." |
| 6 | 1:54–2:12 | **And it refuses**, scrolling the reasons. | "It also declines. No measured exposure. Book one-sided. Size rounds below the venue's minimum lot. Every refusal is on chain with its reason, because a system that only shows you what it did is hiding what it chose not to." |
...
| 8 | 2:51–2:55 | Addresses and repo URL, held. | "Contracts, documents and the full run record are in the repo. Thanks for watching." |
